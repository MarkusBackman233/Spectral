...
Texture2D<float4> g_txProcessed : register(t20);
SamplerState g_samLinear : register(s0);

float4 main(VVSOutput input) : SV_Target
{
    int dx, dy, lod;
    g_txProcessed.GetDimensions(0, dx, dy, lod);
    ...
    float4 color = FxaaPixelShader(input.tex, 0, t, t, t, rcpro, 0, 0, 0, 1.0, 0.166, 0.0312, 0, 0, 0, 0);
